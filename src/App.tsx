  ...
  return (
    <MainLayout>
      <div className="relative w-full h-[4482px] bg-[#ede1d5] overflow-hidden">
        ...
        <div className="absolute w-full h-[534px] top-[2219px] left-0">
        ...
        <div className="absolute top-[2793px] w-full px-6 flex flex-col">
        ...
        <div className="absolute top-[3467px] w-max right-1/2 translate-x-1/2 [font-family:'Noto_Serif',Helvetica] font-normal text-[#67695b] text-base text-center tracking-[3.20px] leading-[normal]">
          XÁC NHẬN THAM DỰ
        </div>
        ...
        <div className="absolute w-full h-[259px] top-[1650px] right-1/2 translate-x-1/2 px-6">
          <div className="mx-auto">
            ...
            />
            <p className="mx-auto mt-[21px] [font-family:'Noto_Serif',Helvetica] font-normal italic text-[#67695b] text-[8px] text-center tracking-[1.44px] leading-[normal]">
        ...
        <div className="absolute w-full top-[3510px] px-6">
          <div className="h-[512px] p-5 bg-[url(https://c.animaapp.com/D4mYxIxt/img/image-8-1.png)] bg-cover bg-[50%_50%]">
            <div className="relative w-full h-[472px] bg-[#2c2825cc]">
